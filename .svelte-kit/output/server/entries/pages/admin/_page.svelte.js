import { d as unsubscribe_stores, h as escape_html, i as attr_class, m as attr, o as derived, u as stringify } from "../../../chunks/index-server.js";
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<!--]--></button> <button type="button"${attr_class(`px-5 py-2.5 rounded-xl font-bold text-sm transition-all flex items-center gap-2 bg-white text-slate-600 hover:bg-slate-200 border border-slate-200`)}><span>Pengaturan KOP</span></button></div></div> `);
		$$renderer.push("<!--[0-->");
